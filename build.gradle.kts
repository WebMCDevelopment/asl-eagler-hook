...
dependencies {
  ...
  compileOnly("ch.andre601.asl-api:api:" + ASLDV_VER)
  compileOnly("ch.andre601.asl-api:platform-velocity:" + ASLDV_VER)
  compileOnly("ch.andre601.asl-api:platform-bungeecord:" + ASLDV_VER)
  compileOnly(files("gradle/libs/AdvancedServerList-Core-$ASLPL_VER.jar"))
...
fun getBungeeDeps(list: List<String>): String {
