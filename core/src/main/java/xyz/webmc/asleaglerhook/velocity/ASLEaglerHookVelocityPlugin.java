...
import xyz.webmc.asleaglerhook.core.ASLEaglerHook;
import xyz.webmc.asleaglerhook.core.IASLEaglerHookPlugin;
import xyz.webmc.asleaglerhook.core.asl.EaglerPingEventWrapper;
...
public final class ASLEaglerHookVelocityPlugin implements IASLEaglerHookPlugin<Favicon> {
  private final ProxyServer proxy;
  private PluginCore<Favicon> plugin;

  @Inject
  public ASLEaglerHookVelocityPlugin(final ProxyServer proxy) {
    this.proxy = proxy;
  }

  @Subscribe
  public final void init(final ProxyInitializeEvent event) {
