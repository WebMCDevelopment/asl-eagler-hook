...
import xyz.webmc.asleaglerhook.core.asl.EaglerASLPlaceholder;
...
public final class ASLEaglerHook {
  ...
  public static final boolean isMaintenance() {
    ...
    } catch (final ClassNotFoundException | IllegalAccessException | NoSuchMethodException | SecurityException | InvocationTargetException ex) {
      return false;
    }
  }
}
